import 'package:calendar_mgmt_services_app/features/restaurant/enum/weekday.dart';
    ...
    try {
      ...
      return BusinessHours(
        start: TimeOfDay(
            ...
            minute: int.parse(startStr.substring(2))),
        end: TimeOfDay(
            hour: int.parse(endStr.substring(0, 2)),
            minute: int.parse(endStr.substring(2))),
